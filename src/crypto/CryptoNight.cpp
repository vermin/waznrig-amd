...
static void patchAsmVariants()
{
    ...
    patchCode(cn_trtl_mainloop_ivybridge_asm,            cnv2_mainloop_ivybridge_asm,           CRYPTONIGHT_TRTL_ITER,   CRYPTONIGHT_ULTRALITE_MASK);
    patchCode(cn_trtl_mainloop_ryzen_asm,                cnv2_mainloop_ryzen_asm,               CRYPTONIGHT_TRTL_ITER,   CRYPTONIGHT_ULTRALITE_MASK);
    patchCode(cn_trtl_mainloop_bulldozer_asm,            cnv2_mainloop_bulldozer_asm,           CRYPTONIGHT_TRTL_ITER,   CRYPTONIGHT_ULTRALITE_MASK);
    patchCode(cn_trtl_double_mainloop_sandybridge_asm,   cnv2_double_mainloop_sandybridge_asm,  CRYPTONIGHT_TRTL_ITER,   CRYPTONIGHT_ULTRALITE_MASK);
...
CryptoNight::cn_hash_fun CryptoNight::fn(xmrig::Algo algorithm, xmrig::AlgoVerify av, xmrig::Variant variant)
{
    ...
    static const cn_hash_fun func_table[] = {
        ...
        cryptonight_single_hash_wrapper<CRYPTONIGHT, VARIANT_FAST_2>,
